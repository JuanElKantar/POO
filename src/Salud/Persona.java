...
public void setSexo(String sexo) {
   ...
   public void pedirDatos(){
    ...
    System.out.println("Por favor digita tu tipo de documento");
    tipoDoc=Lectura.next();

    System.out.println("Por favor digita tu numero de documento");
    documento=Lectura.nextInt();

    System.out.println("Por favor digita tu nombre");
    nombre=Lectura.next();
    
    System.out.println("Por favor digita tu apellido");
    apellido=Lectura.next();


    /* ->RETO1 Y RETO2<-
    System.out.println("Por favor digita tu peso");
    peso=Lectura.nextDouble();
    System.out.println("Por favor digita tu estatura");
    estatura=Lectura.nextDouble();
    System.out.println("Por favor digita tu edad");
    edad=Lectura.nextInt();
    System.out.println("Por favor digita tu sexo");
    sexo=Lectura.next();*/
   }
